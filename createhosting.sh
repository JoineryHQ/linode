...
function usage {
  ...
  echo "    -l: (string) linode label"
  echo "    -r: (string) linode region; reference:"
  echo "        https://www.linode.com/docs/api/regions/#regions-list"
  echo "    -t: (string) linode type; reference:"
  echo "        https://www.linode.com/docs/api/linode-types/#types-list"
  echo "    -s: (string) Server/host name"
  echo "    -u: (string) Customer user name"
  echo "    -d: (string) Customer domain name"
  echo "    -y: (null) If given, script will not prompt for confirmation"
